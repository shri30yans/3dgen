...
import '../styles/Button.css'; // Assuming you saved the CSS in a file named Button.css
...
function FormPage1() {
  ...
  //     <h1 style={{ fontWeight: 'bold' }}>3D Gen AI Model</h1> {/* Header line in bold */}
  //     <label className="prompt-input">
  //       Enter a prompt:
  //       <input type="text" className="prompt-textbox" value={prompt} onChange={handlePromptChange} />
  //     </label>
  ...
  <Link className="btn-content" to="/form/2">
    ...
    <span className="icon-arrow">
      ...
      {/* <Link to="/form/2"><button className="gradient-button" type="submit">Continue</button></Link> */}
    </form>
  );
}
